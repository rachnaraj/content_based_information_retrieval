<%-- 
    Document   : forward_index_pdf
    Created on : 13 Jul, 2017, 9:00:56 AM
    Author     : Anirban
--%>
...
File din = new File("C:\\Users\\user_name\\Desktop\\drdo_project\\pdf_files\\");
	...
	out.println(map);
		...
		String sql = "INSERT INTO relevant_words_pdf( doc_name, words, frequency, total_words) VALUES (?,?,?,?)";
