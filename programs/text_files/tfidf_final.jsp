...
<%-- 
    Document   : tfidf_final
    Created on : 4 Jul, 2017, 5:26:14 PM
    Author     : Anirban
--%>
	...
	<body>
		 ...
		 <script>
			...
			function gofront()
			{
				...
				window.location.href="http://localhost:8080/raproject/home_final.html";
			}
		...
		String[] stopwords = {"a", "about", "above", "above", "across", "after", "afterwards", "again", "against", "all", "almost",
            ...
            "him", "himself", "his", "how", "however", "hundred", "ie", "if", "in", "inc", "inSFd", "interest", "into",
		...
		{	
			...
			out.println("error in retriving information from the database");
                        ...
                        i--;
                        Total_docs = Doc_id[i] - Doc_id[0] + 1; //instead of incrementing each time, used mathamatical logic
		}catch(Exception e)
		{
				out.println(e);
		...
		<%
			...
			{
				String abc = query_after_delete.next(); //word till next space
				out.println(abc);
			}
		%>
		...
		%>
                 ...
                 <%
                    // loop to get idf for each relevant query word and then
               ...
               %>
                ...
                <%
                    // sorting documents based on their corresponding tfidf values
                ...
                <%
                 ...
                 for(int i = 0;i < sort_tfidf.size();i++)
                    ...
                    %>
                    <!-- insertion sort to sort the array in descending order; instead of using inbuilt sort methods -->
                  <%
