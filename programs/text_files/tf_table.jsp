...
<html>
	...
	<body>
		 ...
		 <input type="button" onclick="gofront()" value="NEXT" />
	...
	<%
		...
		qRelevant_tokens = qRelevant.split(" "); //qRelevant holds relevant_words from user query
		...
		<%
			...
			{
				String abc = query_after_delete.next(); //next() takes input till space
				out.println(abc);
			}
		%>
