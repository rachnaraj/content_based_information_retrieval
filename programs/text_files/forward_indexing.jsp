<%-- 
    Document   : stop_words_final
    Created on : 13 Jun, 2017, 1:34:17 PM
    Author     : Anirban
--%>
...
<html>
    ...
    <body>
	  ...
	  try{
		...
		// searching would be faster if stopwords could be changed to HashSet instead of array 
...
File din = new File("C:\\Users\\User_Name\\Desktop\\sample_set_files\\");
	...
	while(scnn.hasNext())
	{
		wordNumber++;
		int flag = 1;
		String word = scnn.next(); //next complete token till new line
	...
	out.println(map);
		...
		String sql = "INSERT INTO relevant_words( doc_name, words, frequency, total_words) VALUES (?,?,?,?)";
				...
				try{
					...
					ps.setInt(4,wordNumber); //this count includes the counts for stopwords
